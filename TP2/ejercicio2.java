...
public class Laboratorio{
	...
	public String mostrar(){
		...
		//System.out.println("La compra minima es de: " + getCompraMin() + "\tEl dia de entrega es: " + getDiaEntrega());
	}

	// Ejecutar
	public class CrearLaboratorio{
		public static void main(String[] args) {
			Laboratorio unLaboratorio = new Laboratorio("Farmacia S.A", "Juan J. Arce 963", "+54-18-4637-2131");

			//unLaboratorio.nuevaCompraMinima(3);
			//unLaboratorio.nuevoDiaEntrega(20);
